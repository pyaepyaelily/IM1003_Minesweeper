...
public final class MineSweeper extends JFrame implements MouseListener, ActionListener {
    ...
    public int rows = 0; //0 to get user's input
    public int columns = 0; //0 to get user's input
    ...
    public MineSweeper() {
        ...
        //To click on the smiley icon to restart the game
